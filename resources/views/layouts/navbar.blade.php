<div class="sticky-top pt-0 pb-2">
    <nav class="navbar navbar-expand-lg bg-white border shadow-sm rounded-3 py-3 px-4"
        ...
        <div class="container-fluid p-0">
            ...
            <a class="navbar-brand fw-bold text-primary fs-4 m-0 text-decoration-none" href="{{ route('dashboard') }}">
                <i class="bi bi-shop me-2"></i>Berkah Fashion
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav mb-2 mb-lg-0 align-items-lg-center gap-2 me-3">
                    ...
                    <li class="nav-item">
                        <a class="btn {{ Request::is('dashboard*') ? 'btn-primary fw-bold shadow-sm' : 'btn-light text-dark' }}"
                    ...
                    @if (auth()->check() && auth()->user()->role_id == 1)
                        <li class="nav-item">
                            <a class="btn {{ Request::is('admin/users*') ? 'btn-primary fw-bold shadow-sm' : 'btn-light text-dark' }}"
                    ...
                    @if (auth()->check() && auth()->user()->role_id == 1)
                        <li class="nav-item">
                            <a class="btn {{ Request::is('jenis*') ? 'btn-primary fw-bold shadow-sm' : 'btn-light text-dark' }}"
                    ...
                    <li class="nav-item">
                        <a class="btn {{ Request::is('produk*') ? 'btn-primary fw-bold shadow-sm' : 'btn-light text-dark' }}"
                    ...
                    <li class="nav-item">
                        <a class="btn {{ Request::is('penjualan*') ? 'btn-primary fw-bold shadow-sm' : 'btn-light text-dark' }}"
